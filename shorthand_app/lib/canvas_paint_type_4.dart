...
import 'package:shorthand_app/tally_marks_five_processor_service.dart';

class CanvasPaintType4 extends StatefulWidget {
  const CanvasPaintType4({super.key});

  @override
  _CanvasPaintType4State createState() => _CanvasPaintType4State();
}

class _CanvasPaintType4State extends State<CanvasPaintType4> {
  late final PointsManager _pointsManager;
  late final TallyMarksFiveProcessorService _processor;
  Line? _currentLine;
  ...
  void initState() {
    ...
    _processor = TallyMarksFiveProcessorService();
  }
...
class _CanvasPainter extends CustomPainter {
  ...
  final TallyMarksFiveProcessorService processorService;
