...
class MarsilianaTabletProcessor extends CanvasProcessor {
  bool isC(List<List<Point>> lines) {
    ...
    final firstLeft = StrokeInspector.isDirectionUp(segments[0]);
    final secondRight = StrokeInspector.isDirectionDown(segments[1]);

    // bounding box of first width smaller than second which end point is higher thant first (to separate from letter l)
